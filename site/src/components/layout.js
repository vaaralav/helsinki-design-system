...
import { Header, Footer, Link, SideNavigation, IconCheckCircleFill, IconCrossCircle } from 'hds-react';
import Seo from './Seo';
    ...
    <>
      ...
      <div className="page text-body">
        <Header id="page-header"
          ...
          <Header.ActionBar title={<NavigationTitle />} titleAriaLabel="Helsinki: Helsinki Design System" titleHref={siteUrl} />
